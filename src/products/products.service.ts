...
export class ProductsService {
 ...
 const verificarCategories = await this.categoryRepositorio.find()
 if(verificarCategories.length === 0){ 
 throw new BadRequestException('no hay categorias creadas para asignar al  producto')
}
